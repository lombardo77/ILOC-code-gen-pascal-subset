...
condexp	: exp NEQ exp		{ 
	...
	| exp LT exp	{
                        ...
                        $$.inst = CMPLT;
                        $$.r1 = $1.targetRegister1;
                        $$.r2 = $3.targetRegister1;
...
lvalue	: ID {
        ...
        |  ID '[' exp ']' {
                ...
                emit(NOLABEL, LOADI, 1, reg3, EMPTY);
                emit(NOLABEL, SUB, $3.targetRegister, reg3, reg4);
                emit(NOLABEL, MULT, reg4, reg2, reg5);
                emit(NOLABEL, ADD, reg1, reg5, reg6);
               
                emit(NOLABEL, ADD, reg6, 0, reg7);
                $$.targetRegister = reg7;
                $$.name = $1.str;
...
rvalue : ID {
       ...
       | ID '[' exp ']' {
            ...
            //emit(NOLABEL, ADD, reg1, reg6, reg7);

            emit(NOLABEL, ADD, reg6, 0, reg7);
            emit(NOLABEL, LOAD, reg7, reg8, EMPTY);
            $$.targetRegister = reg8;
            $$.name = $1.str;
